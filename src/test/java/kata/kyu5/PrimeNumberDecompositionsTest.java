...
public class PrimeNumberDecompositionsTest {
    private static PrimeNumberDecompositions worker;
    ...
    public PrimeNumberDecompositionsTest(long n, long[] factors, long[][] uniqueFactors, long[] factorProducts) {
        this.n = n;
    ...
    public static void init() {
        worker = new PrimeNumberDecompositions();
    }
